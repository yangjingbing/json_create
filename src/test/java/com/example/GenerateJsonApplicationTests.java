...
@SpringBootTest
class GenerateJsonApplicationTests {
...
//        ground_000001.put("type", "FBX");
        modelDefGroupArray.add(ground_000001);
...
//            modelDefGroupObject.put("type", "FBX");
...
//                layerGroupObject.put("height", new Double[]{modelFiles.getHeight()});
            ...
            JSONObject transformObject = new JSONObject(true);
            JSONObject translateObject = new JSONObject(true);
            translateObject.put("x", x);
            translateObject.put("y", y);
            translateObject.put("z", z);
            transformObject.put("translate", translateObject);
            transformObject.put("rotate", 0.0);
            transformObject.put("scale", 1.0);
            buildingGroupObject.put("transform", transformObject);
